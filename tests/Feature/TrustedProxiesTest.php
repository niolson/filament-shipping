...
it('resolves the real client IP from X-Forwarded-For behind trusted proxies', function () {
...
it('ignores a spoofed leading X-Forwarded-For entry', function () {
    $this->call('GET', '/__ip_probe', [], [], [], [
...
it('does not honor X-Forwarded-For from an untrusted (direct) connection', function () {
