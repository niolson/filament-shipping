...
**Action item resolved:** `docs/issues/special-services/usps-stc-list.csv` is now the durable, greppable source of truth for this matrix — no need to re-derive it from prose docs.
