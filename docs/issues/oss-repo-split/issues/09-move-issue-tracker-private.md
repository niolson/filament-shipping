...
- [ ] The **Agent skills** section is correct. It lives once, at the end of `AGENTS.md` (`CLAUDE.md` is just `@AGENTS.md` since issue 08), and currently says issues live under `docs/issues/` and points at `docs/agents/issue-tracker.md`. Issue 08 left it accurate for the pre-move state; this issue owns the post-move state
