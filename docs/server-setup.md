...
Expect `Active` and real rows. This step deliberately runs 8.0 by hand rather
...
how you record that a human verified the migration; it is also reversible if
step 3 ever needs repeating.
