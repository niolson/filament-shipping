...
return [
    ...
    // Must stay false: Amazon's SP-API data protection policy forbids
    // sending buyer PII (names, addresses, emails, phones) to third parties.
    'send_default_pii' => env('SENTRY_SEND_DEFAULT_PII', false),

    // Never attach request bodies — Livewire POSTs (Manual Ship, Pack)
    // carry recipient addresses. Same Amazon PII constraint as above.
    'max_request_body_size' => 'none',

    // Key-based PII redaction on everything that leaves the app.
    'before_send' => [SentryPiiScrubber::class, 'scrub'],
